...
The project **testApi** is a Bonita REST API extension for **Bonita 7.12.1** version  **community** written in `java`
...
[source,bash]
----
git clone https://your.github.com/testApi.git
cd testApi/
./mwnw package
----

The build should produce a zip archive under the `target/` folder named `test-api-1.0.zip`
